...
class EvolRingB:
    def __init__(self,load=False,n_gts=100,n_gens=100,n_parents=20,mut_rate=0.15,n_trials=10,timesteps=1000,world_size=10,world_th0=0.2):
        self.n_gts = n_gts
        self.n_gens = n_gens
    ...
    def evolve(self):
        ...
        for n_gen in range(self.n_gens):
            ...
            # print data
            print('current best fitness = {}'.format(self.cb_ft))
    ...
    def evolve_menu(self):
        ...
        while evol_menu==True:
            ...
            if em_in == 'q':
                ...
                try:
                    if em_in == 'load':
                        self.cb_genotypes = loader.load(wdir=self.fpath,ext=self.fext,auto=False,return_gts=True)
                    elif em_in == 'ngt':
    ...
    def save_data(self):
        ...
        filename = '{}_g{:04}_ft={}.{}'.format(self.fname,self.cb_ft,self.fext)
